...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'عقاري'); ?></title>
...
?>
<?php if(! $hideUserNavbar): ?>
<header class="topbar">
    <nav class="nav">
        <a class="brand" href="<?php echo e(route('user.dashboard')); ?>">🏠 عقاري</a>
        <div class="nav-links">
            <a class="nav-link <?php echo e(request()->routeIs('user.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('user.dashboard')); ?>">الرئيسية</a>
            <a class="nav-link <?php echo e(request()->routeIs('user.properties.*') && !request()->routeIs('user.properties.my') ? 'active' : ''); ?>" href="<?php echo e(route('user.properties.index')); ?>">العقارات</a>
            <a class="nav-link <?php echo e(request()->routeIs('user.properties.my') ? 'active' : ''); ?>" href="<?php echo e(route('user.properties.my')); ?>">عقاراتي</a>
            <a class="nav-link <?php echo e(request()->routeIs('user.search') ? 'active' : ''); ?>" href="<?php echo e(route('user.search')); ?>">البحث</a>
            <a class="nav-link <?php echo e(request()->routeIs('user.nearby') ? 'active' : ''); ?>" href="<?php echo e(route('user.nearby')); ?>">القريبة</a>
            <a class="nav-link <?php echo e(request()->routeIs('user.favorites') ? 'active' : ''); ?>" href="<?php echo e(route('user.favorites')); ?>">المفضلة</a>
            <a class="nav-link <?php echo e(request()->routeIs('user.chats.*') ? 'active' : ''); ?>" href="<?php echo e(route('user.chats.index')); ?>">المحادثات <span id="messageBadge" class="nav-badge">0</span></a>
            <a class="nav-link <?php echo e(request()->routeIs('user.notifications') ? 'active' : ''); ?>" href="<?php echo e(route('user.notifications')); ?>">الإشعارات <span id="notificationBadge" class="nav-badge">0</span></a>
            <a class="nav-link <?php echo e(request()->routeIs('user.account') ? 'active' : ''); ?>" href="<?php echo e(route('user.account')); ?>">الحساب</a>
        </div>
...
<script>
    ...
    const REALTIME_CONFIG = {
        broadcaster: <?php echo json_encode(config('broadcasting.default'), 15, 512) ?>,
    ...
    async function api(path, options = {}) {
        ...
        if (response.status === 401) {
            clearAuth();
            if (!location.pathname.endsWith('/login')) location.href = '<?php echo e(route('user.login')); ?>';
        }
        if (!response.ok) {
    ...
    function requireAuth() {
        if (!token()) {
            location.href = '<?php echo e(route('user.login')); ?>';
            return false;
        }
        return true;
    }
...
<?php /**PATH C:\Users\نغم\Downloads\property-finder-user-web-api-final\property-finder-user-web-api-final\property_finder_final\resources\views/user/layout.blade.php ENDPATH**/ ?>