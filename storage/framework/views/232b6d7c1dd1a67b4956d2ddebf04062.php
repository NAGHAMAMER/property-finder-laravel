<?php $__env->startSection('title', 'تفاصيل العقار'); ?>
...
<script>
    const propertyId = <?php echo e((int) $id); ?>;
    ...
    async function deleteProperty() {
        ...
        try {
            ...
            location.href = '<?php echo e(route('user.properties.my')); ?>';
        } catch (error) {
            showAlert('alert', error.message, 'error');
        }
    }
...
<?php echo $__env->make('user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\نغم\Downloads\property-finder-user-web-api-final\property-finder-user-web-api-final\property_finder_final\resources\views/user/properties/show.blade.php ENDPATH**/ ?>